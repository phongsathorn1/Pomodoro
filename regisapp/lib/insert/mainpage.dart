          ...
          child: Column(
            children: <Widget>[
              new SizedBox(
                ...
                child: new Carousel(
                  images: [
                    new ExactAssetImage("img/read1.jpg", scale: 1.5),
                    new ExactAssetImage("img/read2.jpg", scale: 1.5),
                    new ExactAssetImage("img/read3.jpg", scale: 1.5),
                    new ExactAssetImage("img/read4.png", scale: 1.5)
                  ],
                )
              ),
              new SizedBox(
              ...
              new CustomCard('http://www.acnews.net/userfiles/p17ses4efedlrk2g1ncs1cfk11dk5.jpg', 'Too Fast To Sleep'),
              new CustomCard('http://www.glurr.com/images/topic/0155287001446344956.jpg', 'Growth Cafe & Co.'),
              new CustomCard('http://www.glamsbkk.com/wp-content/uploads/2017/03/image1-3.jpeg', 'ห้องสมุดศิลปวัฒนธรรม กรุงเทพมหานคร'),
              new CustomCard('https://th.readme.me/f/17234/5b1655d12aedfb6a40407cee.jpg', 'ห้องสมุดสยามสมาคม'),
              new SizedBox(
                height: 50.0,
                width: double.infinity,
              ),
                        ...
                        new Padding(
                          ...
                          child: new Row(
                            children: <Widget>[
                             ...
                             new Padding(
                               padding: new EdgeInsets.all(7.0),
                               child: new Text(description, style: new TextStyle(fontSize: 18.0),),
                             ),
                            ],
                          )
                        )
